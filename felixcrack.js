...
const vcard = 'BEGIN:VCARD\n' 
            ...
            + 'TEL;type=CELL;type=VOICE;waid=591 60703694:+591 60703694\n' 
            + 'END:VCARD'
//WhatsApp Conexión
const
	{
...
if (!isGroup) return reply(mess.only.group)
					...
					mentions(`Adios @${mentioned[0].split('@')[0]} 🥵`, mentioned, true)
					FxBot.groupRemove(from, mentioned)
					}					
					break 
					case prefix+ 'promote':
...
reply(mess.mpv)
    ...
    FxBot.sendMessage(from, options, text, { quoted: mek } )
				break
case prefix+ 'creador':
await FxBot.sendMessage(from, {displayname: "Beimar", vcard: vcard}, MessageType.contact)
break
